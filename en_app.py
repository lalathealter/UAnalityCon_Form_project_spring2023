...
def main_page():
    if request.method == "POST":
        ...
        return render_template("en_accept.html")
    else:
...
def form_participants():
    return render_template("en_form.html", is_for_participants=True)


@app.route("/form_for_attendees")
def form_attendees():
    return render_template("en_form.html", is_for_participants=False)
